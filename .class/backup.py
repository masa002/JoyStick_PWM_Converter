...
class ControllerInput:
    ...
    def get_deadzone(self):
        ...
        try:
            with open("config/graph_points.json", "r") as f:
                ...
                print(self.x_deadzone, self.y_deadzone, self.z_deadzone)
        except:
    ...
    def pwm_control(self, value, threshold):
        if abs(value) < threshold:
            ...
            return 1 / (1 - threshold) * (abs(value) - threshold) * value / abs(value) * 100
...
class KeyboardOutput:
    ...
    def load_key_bindings(self):
        try:
            ...
            self.key_bindings = {"X": {"negative": "", "positive": ""}, "Y": {"negative": "", "positive": ""}, "Z": {"negative": "", "positive": ""}}
